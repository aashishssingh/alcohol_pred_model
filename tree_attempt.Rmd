---
title: "STATS 101C -- Kaggle Project tree attempt"
...
library(tree) # used this one this time
...
setwd("C://Users//ashis//OneDrive//Desktop//STATS_101C//Kaggle_Project")
...
tree1 <- tree(Alcoholic.Status ~ ., data = traindata)
...
pred <- predict(tree1, testdata, type = "class")

write.csv(data.frame("ID"=c(1:30000), "Alcoholic.Status" = pred), 
          row.names = FALSE, 
          "C://Users//ashis//OneDrive//Desktop//STATS_101C//Kaggle_Project//Tree_attempt//treepredsolution.csv")
