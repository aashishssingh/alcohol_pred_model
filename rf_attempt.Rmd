---
title: "STATS 101C -- Kaggle Project rf model"
...
rf_model <-  randomForest(Alcoholic.Status ~ ., data = traindata, 
                          mtry = 5, importance = TRUE, ntree = 5000)

pred <- predict(rf_model, newdata = testdata, type = "class")

write.csv(data.frame("ID"=c(1:30000), "Alcoholic.Status" = pred), 
          row.names = FALSE, 
          "C://Users//ashis//OneDrive//Desktop//STATS_101C//Kaggle_Project//rf_attempt//rfpred5solution.csv")
