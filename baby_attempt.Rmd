---
title: "STATS 101C -- Kaggle Project ridge attempt"
...
model1 <- glm(Alcoholic.Status ~ ., data = traindata, family = "binomial")
...
pred <- predict(model1, testdata, type = "response")
...
write.csv(data.frame("ID"=c(1:30000), "Alcoholic.Status" = pred_adj), 
          row.names = FALSE, 
          "C://Users//ashis//OneDrive//Desktop//STATS_101C//Kaggle_Project//baby_attempt//glmpredsolution.csv")
